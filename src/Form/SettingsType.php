...
namespace HG\SettingsBundle\Form;
...
class SettingsType extends AbstractType
{
  ...
  public function __construct($settingsManager, $entityManager)
  {
    $this->settings = $entityManager->getRepository('HGSettingsBundle:Setting')->findAll();
  ...
  public function buildForm(FormBuilderInterface $builder, array $options)
  {
    foreach ($this->settings as $setting)
    {
      ...
      if (!$setting->getCultureAware())
      {
        ...
        {
          $builder->add(
           $builder->create($setting->getId(), 'form', array('label' => false))
      ...
      {
        $oneForm = $builder->create($setting->getId(), 'form', array('label' => false));
      ...
      $builder->add('Beállítások mentése', 'submit', array('attr' => array('class' => 'btn btn-primary')));
  }
